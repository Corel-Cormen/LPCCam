...
#define BOARD_INITPINS_LCD_RST_GPIO	GPIO
#define BOARD_INITPINS_LCD_RST_PORT	1
#define BOARD_INITPINS_LCD_RST_PIN 9

#define BOARD_INITPINS_LCD_DC_GPIO GPIO
#define BOARD_INITPINS_LCD_DC_PORT 1
#define BOARD_INITPINS_LCD_DC_PIN 10
